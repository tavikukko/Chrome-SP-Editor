...
(function (global, factory) {
    ...
    var AuthUrlException = /** @class */ (function (_super) {
        tslib_1.__extends(AuthUrlException, _super);
        function AuthUrlException(data, msg) {
            ...
            logging.Logger.log({ data: data, level: 3 /* Error */, message: _this.message });
            return _this;
        }
    ...
    var SPFetchClient = /** @class */ (function () {
        ...
        SPFetchClient.prototype.fetch = function (url, options) {
            if (!common.isUrlAbsolute(url)) {
                url = common.combinePaths(this.siteUrl, url);
            }
    ...
    var AdalFetchClient = /** @class */ (function () {
        function AdalFetchClient(_tenant, _clientId, _secret, _resource, _authority) {
            ...
            this.authContext = new adalNode.AuthenticationContext(common.combinePaths(this._authority, this._tenant));
        }
        AdalFetchClient.prototype.fetch = function (url, options) {
            ...
            if (!common.isUrlAbsolute(url)) {
                url = common.combinePaths(this._resource, url);
            }
