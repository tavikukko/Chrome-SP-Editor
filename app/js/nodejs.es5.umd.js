...
(function (global, factory) {
            ...
            var SharePointServicePrincipal = "00000003-0000-0ff1-ce00-000000000000";
            (function (SPOAuthEnv) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                resource = getFormattedPrincipal(SharePointServicePrincipal, u.parse(params.siteUrl).hostname, params.realm);
