...
export declare const Message: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IMessage & import("../../odata/invokable-binder.js").IInvokable<any>;
/**
 * Messages
 */
...
export declare const Messages: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IMessages & import("../../odata/invokable-binder.js").IInvokable<any>;
/**
 * MailFolder
 */
...
export declare const MailFolder: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IMailFolder & import("../../odata/invokable-binder.js").IInvokable<any>;
/**
 * MailFolders
 */
...
export declare const MailFolders: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IMailFolders & import("../../odata/invokable-binder.js").IInvokable<any>;
/**
 * MailboxSettings
 */
...
export declare const MailboxSettings: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IMailboxSettings & import("../../odata/invokable-binder.js").IInvokable<any>;
