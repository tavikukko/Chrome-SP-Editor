...
export declare const User: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IUser & import("../../odata/invokable-binder.js").IInvokable<any>;
...
export declare const Users: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IUsers & import("../../odata/invokable-binder.js").IInvokable<any>;
export declare class _People extends _GraphQueryableCollection<IPersonType[]> {
}
export interface IPeople extends _People {
}
export declare const People: (baseUrl: string | import("../graphqueryable.js").IGraphQueryable<any>, path?: string) => IPeople & import("../../odata/invokable-binder.js").IInvokable<any>;
