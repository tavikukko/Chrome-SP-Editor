...
type Props = ReturnType<typeof mapStateToProps> & ReturnType<typeof mapDispatcherToProps>;
...
class HomePage extends React.Component<Props, IHomeState> {
  ...
  private onInputChange = (e: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>, newValue?: string) => {
  ...
  public render() {
    ...
    return (
      <div style={{ margin: '20px' }}>
        <TextField label="Standard" value={this.state.inputText} onChange={this.onInputChange} />
        <PrimaryButton
          text="Add item"
